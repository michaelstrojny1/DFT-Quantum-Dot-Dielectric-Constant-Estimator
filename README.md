# DFT Quantum Dot Dielectric Constant Estimator (Includes **FEA runner for Bai Lab Experiment (Top Capacitor Plate -> HBN -> 2D QD Pattern -> HBN -> Graphene -> HBN -> Bottom Plate)
