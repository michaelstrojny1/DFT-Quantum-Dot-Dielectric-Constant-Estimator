...
def main():
    demo_cmd = [
        ...
        "--nx", "64", "--ny", "64", "--nz", "48",  # Reduced grid for speed and memory safety
        "--order", "2",  # Use quadratic elements when available (falls back automatically)
        "--E-Vnm", "0.15",
        "--lateral-bc", "natural",
